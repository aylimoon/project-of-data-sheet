% РП.АУС.П PS.AUS.P Тренажер педиатрической аускультации
...
\newcommand{\typesimulator}{0}   % РП.АУС.П Тренажер педиатрической аускультации
%\newcommand{\typesimulator}{1}   %  Отсутствует
%\newcommand{\typesimulator}{2}   %  Отсутствует
%\newcommand{\typesimulator}{3}    %  Отсутствует
%\newcommand{\typesimulator}{4}     % выставочный образец 1
...
% РП.АУС.П
\newcommand{\productmainview}{PS_AUS_P-1}
\newcommand{\producttrademarktype}{}
\ifIsLngRus\newcommand{\producttechchardimension}{450x450x680}\else\newcommand{\producttechchardimension}{450x450x680}\fi % Габаритные размеры симулятора
...
\ifIsLngRus % определение переменных на русском языке
    ...
    \newcommand{\productname}{Тренажер педиатрической аускультации}
    ...
    \newcommand{\producttype}{РП.АУС.П}

    %---Комплектация---
    \newcommand{\productequip}
    {
        Полуторсовый манекен пациента подростка на подставке & \\ \hline
    ...
    \newcommand{\productequip}
    {
        Полуторсовый манекен пациента подростка серийный № 01343548 & 1 \\ \hline
        Подставка под манекен серийный №01343548 & 1 \\ \hline
        Зарядное устройство симулятора серийный №01343548 & 1 \\ \hline
        Ноутбук ASUS серийный № JAN0CV08B341422 & 1 \\ \hline
        Роутер серийный №01343548 & 1 \\ \hline
        Демонстрационный набор серийный №01343548 & 1 \\ \hline
        Сетевой фильтр серийный №01343548 & 1 \\ \hline
...
\else % определение переменных на английском языке
    ...
    %---Определение значения переменных не зависящих от типа симулятора---
    \newcommand{\productname}{Pediatric Patient Auscultation Simulator}
    ...
    % PS.AUS
    \newcommand{\producttype}{PS.AUS.P}

    %---Комплектация---
    \newcommand{\productequip}
    {
        Half-body pediatric manikin on a platform & \\ \hline
