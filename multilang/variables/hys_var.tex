% ГС HYS Виртуальный симулятор гистероскопических вмешательств
...
\newcommand{\producttrademark}{HystVision}
...
%{Базовая модификация} 
\newcommand{\productmainview}{B_HYS-1}
...
\ifIsLngRus % определение переменных на русском языке
    ...
    \newcommand{\productname}{Виртуальный симулятор гистероскопических вмешательств}
...
\else % определение переменных на английском языке
    ...
    %---Определение значения переменных не зависящих от типа симулятора---
    \newcommand{\productname}{Virtual Simulator for Practical Skills in Hysteroscopy}
