% Шаблон файла содержащего переменные для симуляторов (не РП)
...
\ifIsLngRus % определение переменных на русском языке
    ...
    \newcommand{\productequip}
    {
        Основа симулятора со стойкой  &  \\ \hline
        Сенсорный монитор  &  \\ \hline
        ЖК-монитор  &  \\ \hline
        Кронштейн для двух мониторов  &  \\ \hline
        Имитаторы эндоскопа  &  \\ \hline
        Держатель для эндоскопов  &  \\ \hline
        Универсальный имитатор эндоскопических инструментов  &  \\ \hline
        Универсальный имитатор шприца  &  \\ \hline
        Двухклавишная педаль  &  \\ \hline
        Шнур для подключения питания  &  \\ \hline
...
\else % определение переменных на английском языке
    ...
    \newcommand{\productequip}
    {
        Simulator body  &  \\ \hline
        Touchscreen monitor  &  \\ \hline
        LCD  &  \\ \hline
        Screen holder  &  \\ \hline
        Endoscope imitators  &  \\ \hline
        Endoscope holder  &  \\ \hline
        Multi-purpoe endoscopic instrument imitator  &  \\ \hline
