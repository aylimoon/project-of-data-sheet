% РП.ВП PS.VI Виртуальный пациент
...
\newcommand{\typesimulator}{0}   % РП.ВП PS.VI Виртуальный пациент
...
\newcommand{\producttrademarknametwo}{}
...
% РП.ВП
\newcommand{\productmainview}{LeonardoVR}
\newcommand{\producttrademarktype}{VR}
\ifIsLngRus\newcommand{\producttechchardimension}{1300х780х950}\else\newcommand{\producttechchardimension}{1,300х780х950}\fi % Габаритные размеры симулятора
\newcommand{\producttechcharweighs}{106} % Вес симулятора
\newcommand{\producttechcharpower}{900} % Потребляемая мощность
...
\ifIsLngRus % определение переменных на русском языке
    ...
    \newcommand{\productname}{Виртуальный пациент}
    ...
    \newcommand{\producttype}{РП.ВП}

    %---Комплектация---
    \newcommand{\productequip}
    {
        Стол с сенсорным экраном & \\ \hline
...
\else % определение переменных на английском языке
    ...
    %---Определение значения переменных не зависящих от типа симулятора---
    \newcommand{\productname}{Interactive Virtual Patient Simulator}
